...
export default function PendingData() {
  ...
  const [selectedBastiId, setSelectedBastiId] = useState("");
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchText, selectedBastiId, households.length]);
    ...
    () =>
      households
        ...
        .filter((hh) => {
          ...
          return getHouseholdLocation(hh, bastiNames, margaNames) === selectedBastiId;
        }),
    [households, searchText, selectedBastiId, bastiNames, margaNames]
  );
      ...
      <div className="pending-data-table-wrap">
        ...
        <div className="household-list-toolbar">
          <select
            ...
            value={selectedBastiId}
            onChange={(event) => setSelectedBastiId(event.target.value)}
          >
